...
class App(ctk.CTk):
    ...
    def __init__(self):
        ...
        } # easyfind to enable and disable solvers
        
        self.canvas_sens = None
    ...
    def _setup_sensitivity_plot(self):
        try:
            ...
            return
        if self.canvas_sens is not None:
            try:
                self.canvas_sens.get_tk_widget().destroy()
            except:
                pass
    ...
    def change_solver(self, choice: str):
        print(f"--- CHANGING SOLVER FOR: {choice} ---")
        ...
        if solver_class:
            try:
                ...
                print(f"UI updated for mode: {'MOC' if is_moc else 'Bell'}")
            except Exception as e:
                print(f"ERROR INSTANTIING SOLVER: {e}")
    ...
    def _init_plots(self) -> None:
        ...
        self.combo_pa_unit = ctk.CTkOptionMenu(
            ...
            width=80,
            command=self.update_pa_unit_pref
        )
        self.combo_pa_unit.set("Pa")
    ...
    def open_project(self):
        ...
        try:
            ...
            file_ver_str = data.get("version", "0.0.0")
    ...
    def _export_to_dxf(self, filename: str) -> None:
        ...
        msp = doc.modelspace()
        doc.layers.new(name='NOZZLE_PROFILE', dxfattribs={'color': 4})
        raw_x = res.contour_x
        raw_y = res.contour_y    
        optimized_points = []
        ...
        optimized_points.append((end_x, 0.0))
        optimized_points.append((start_x, 0.0))
        msp.add_lwpolyline(
            optimized_points, 
    ...
    def run_simulation(self):
        ...
        try:
            try:
                params = {
                    'tr': self._get_converted_value('tr'),
                    'k': float(self.inputs['k'].get()),
                    'pc': self._get_converted_value('pc'),
                    'pe': self._get_converted_value('pe'),
    ...
    def _flash_refit_button(self):
        ...
        flash_color = "#FFD54F"
        self.btn_reset_view.configure(fg_color=flash_color, text_color="black") 
    ...
    def _update_separation_status_ui(self, result):
        ...
        elif result.safety_margin < 0.20:
    ...
    def _show_separation_window(self, result, ambient_pressure_pa):
        ...
        # graphic area
        plot_frame = ctk.CTkFrame(win, fg_color="white") 
    ...
    def refresh_separation_only(self):
        ...
        try:
            ...
            len_unit = self.unit_prefs.get('tr', 'mm')
            press_unit = self.unit_prefs.get('pe', 'atm')
